...
import IssueBookDialog from "@/components/dialogs/IssueBookDialog";
import ReturnBookDialog from "@/components/dialogs/ReturnBookDialog";
import AdminManagement from "@/components/modules/AdminManagement";
import { Users, TrendingUp, BookOpen, Award, Plus, Pencil, BookMarked, Layers } from "lucide-react";
...
export default function AdminDashboard({ adminName, adminRole, onLogout }: AdminDashboardProps) {
  ...
  const [deleteType, setDeleteType] = useState<'student' | 'subject' | 'book' | 'notice' | null>(null);
  ...
  const handleDelete = (type: 'student' | 'subject' | 'book' | 'notice', item: any) => {
    setDeleteType(type);
