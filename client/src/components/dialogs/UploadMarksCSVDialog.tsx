    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Upload a CSV file containing marks data. The CSV must have the following headers:
          </DialogDescription>
          <div className="w-full overflow-x-auto py-2">
            <code className="text-xs bg-muted px-2 py-1 rounded whitespace-nowrap inline-block">
              studentId, subjectId, month, testName, marksObtained, totalMarks
            </code>
          </div>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Alert>
            <AlertCircle className="h-4 w-4" />
            <AlertDescription className="w-full overflow-hidden">
              <strong>CSV Format Example:</strong>
              <div className="w-full overflow-x-auto mt-2 pb-2">
                <code className="text-xs whitespace-pre block w-max">
